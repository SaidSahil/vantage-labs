      ...
      >
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 9, textDecoration: 'none' }}>
          <svg width="20" height="20" viewBox="0 0 22 22" fill="none" aria-hidden="true">
            <polygon points="11,1.5 19.5,6.25 19.5,15.75 11,20.5 2.5,15.75 2.5,6.25" stroke="var(--na-logo-color)" strokeWidth="1.3" strokeLinejoin="round"/>
            <line x1="7" y1="7" x2="7"  y2="15" stroke="var(--na-logo-color)" strokeWidth="1.7" strokeLinecap="round"/>
            <line x1="7" y1="7" x2="15" y2="15" stroke="var(--na-logo-color)" strokeWidth="1.7" strokeLinecap="round"/>
            <line x1="15" y1="7" x2="15" y2="15" stroke="var(--na-logo-color)" strokeWidth="1.7" strokeLinecap="round"/>
            <circle cx="7"  cy="7"  r="1.2" fill="var(--na-logo-color)"/>
            <circle cx="15" cy="7"  r="1.2" fill="var(--na-logo-color)"/>
            <circle cx="7"  cy="15" r="1.2" fill="var(--na-logo-color)"/>
            <circle cx="15" cy="15" r="1.2" fill="var(--na-logo-color)"/>
          </svg>
