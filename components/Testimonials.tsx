...
const testimonials = [
  {
    quote: "We had a basic WordPress site that was embarrassing to hand out. Vantage Labs turned it around in under two weeks — it looks like we spent ten times what we paid.",
    name: 'Marcus T.',
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 16 }}>
          <span style={{ fontSize: 13, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#1C1C1E' }}>Client Voices</span>
        </div>
        ...
        {testimonials.map((t, i) => (
          ...
          >
            <svg width="24" height="18" viewBox="0 0 24 18" fill="none" aria-hidden="true">
              <path d="M0 18V10.8C0 7.2 1.2 4.2 3.6 1.8L5.4 0l1.8 1.2C5.4 2.8 4.4 4.8 4.2 7.2H7.2V18H0zm13.2 0V10.8c0-3.6 1.2-6.6 3.6-9L18.6 0l1.8 1.2c-1.8 1.6-2.8 3.6-3 6H20.4V18h-7.2z" fill="#3D5A80" opacity="0.2" />
            </svg>
            ...
            <div style={{ borderTop: '1px solid #E2E1DC', paddingTop: 20 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#1C1C1E', letterSpacing: '-0.01em', marginBottom: 4 }}>
                {t.name}
              </div>
              <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#8A8A8E' }}>
                {t.business}
              </div>
            </div>
          </motion.div>
